...
<div class="card-wrapper">
    <div class="description-card">
        Hi! I am a third year computer science major studying at UC Berkeley. Sometime between graduating and retirement, I plan to travel, play golf, and solve people's problems with computer science. I love technology and how it is making our lives easier, better, and more fun. Interested? Check out some of my projects below or head on over to <a href="http://www.github.com/varunrau">my Github</a> and my <a href="https://www.dropbox.com/s/8adarpsb725sv9k/Resume.pdf">resume.</a>
    </div>
    <div class="sub-header"> Projects </div>
    <div class="project-card">
        <img class="project-image" src="classnotes.png"></img>
        There are some great tools out there that make collaboration easy in engineering. But many of these tools are missing for the classroom. Class Notes brings organized collaboration to the classroom. Using the Google Drive API, it manages a huge collection of Google Docs that can be used to keep a huge collaborative notetaking effort easy and organized. With Class Notes, all you have to do is enter the class you're in and specify the day you want and you can instantly start editting the notes for both yourself and everyone in your class.
    </div>
    <div class="project-card">
